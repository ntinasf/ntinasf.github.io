---
layout: page
title: Ranking Short-Term Rental Listings
subtitle: A learning-to-rank system on 44,684 Inside Airbnb listings, trained locally and deployed on Azure ML
share-title: "Ranking Short-Term Rental Listings"
share-description: "0.753 NDCG@10 on a sealed fold against a 0.552 random floor. How the target was built from public calendars, where the leak was, and what the headline metric cannot see."
share-img: "/assets/images/rental-ranking/result_vs_floor.png"
---
...
[View Repository](https://github.com/ntinasf/rental-ranking){: .btn .btn-primary} · [Read the A/B Test Design](https://github.com/ntinasf/rental-ranking/blob/main/docs/ab_test_design.md){: .btn .btn-info}
...
![The model against both frozen baselines, read against the random floor](/assets/images/rental-ranking/result_vs_floor.png)
...
*Details in: [`01_data_inventory.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/01_data_inventory.ipynb) §1–§3.*
...
![Blocked share against how far ahead the price quote falls](/assets/images/rental-ranking/leak_price_quote_date.png)
...
*Details in: [`01_data_inventory.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/01_data_inventory.ipynb) §4–§5.*
...
![How many listings a search holds](/assets/images/rental-ranking/query_group_sizes.png)
...
*Details in: [`03_feature_analysis.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/03_feature_analysis.ipynb) §1.*
...
![The target's two atoms](/assets/images/rental-ranking/target_atoms.png)
...
*Details in: [`02_label_validation.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/02_label_validation.ipynb) §2, §6.*
...
![Mean target against same-season review count](/assets/images/rental-ranking/review_staircase.png)
...
*Details in: [`02_label_validation.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/02_label_validation.ipynb) §1–§5.*
...
*Details in: [`03_feature_analysis.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/03_feature_analysis.ipynb) §2, §6, §7, §9.*
...
*Details in: [`04_evaluation.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/04_evaluation.ipynb) §1–§3.*
...
![A search the model ranks well](/assets/images/rental-ranking/console_win_kalamaria.png)

Thessaloniki / Kalamaria / 5 guests, 43 listings: 0.8785 against a 0.6163 floor, top three all
grade 4.

![A search the model loses](/assets/images/rental-ranking/console_loss_kypseli.png)
...
*Details in: [`04_evaluation.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/04_evaluation.ipynb) §5, §10.*
...
![The training job on Azure ML](/assets/images/rental-ranking/train_job_overview.png)
...
![The preprocessing pipeline](/assets/images/rental-ranking/preprocess_pipeline_dag.png)
...
*Details in: [`04_evaluation.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/04_evaluation.ipynb) §4, §6, §7, §9, §11.*
...
![Deserving new listings reaching a first screen](/assets/images/rental-ranking/cold_start_reach.png)
...
*Details in: [`04_evaluation.ipynb`](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/04_evaluation.ipynb) §8, §8.1.*
...
experiment, and [`docs/ab_test_design.md`](https://github.com/ntinasf/rental-ranking/blob/main/docs/ab_test_design.md) is that experiment, specified in full
and **not run**.
...
![How the traffic splits: eligibility, assignment, the three candidate-set policies, one shared ranker, two comparisons](/assets/images/rental-ranking/ab_traffic_split.png)
...
![What narrowing costs, and what it buys](/assets/images/rental-ranking/narrowing_tradeoff.png)
...
[`docs/ab_test_design.md`](https://github.com/ntinasf/rental-ranking/blob/main/docs/ab_test_design.md).*
...
**Tools Used:** Python, LightGBM, MLflow, Azure ML, Docker, pandas, scikit-learn, pytest

**Full Analysis Notebooks:**
- [Data Inventory and Leakage Audit](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/01_data_inventory.ipynb)
- [Label Construction and Validation](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/02_label_validation.ipynb)
- [Feature Analysis](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/03_feature_analysis.ipynb)
- [Evaluation, Ablations and Fairness](https://github.com/ntinasf/rental-ranking/blob/main/notebooks/04_evaluation.ipynb)

**Experiment Design:** [The full A/B test specification](https://github.com/ntinasf/rental-ranking/blob/main/docs/ab_test_design.md)

[View Full Project on GitHub](https://github.com/ntinasf/rental-ranking){: .btn .btn-primary}
